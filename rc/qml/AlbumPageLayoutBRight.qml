...
Item {
  ...
  FramePortrait {
    ...
    topMargin: albumPageLayoutBRight.topMargin
    bottomMargin: albumPageLayoutBRight.bottomMargin
    leftMargin: albumPageLayoutBRight.gutterMargin
    rightMargin: albumPageLayoutBRight.outerMargin

    mediaSource: (mediaSourceList ? mediaSourceList[2] : null)
    isPreview: albumPageLayoutBRight.isPreview
  }
}
