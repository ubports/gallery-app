...
QVariant QmlMediaCollectionModel::createAlbumFromSelected() {
  ...
  GalleryManager::GetInstance()->GetAlbumCollection()->Add(album);
...
void QmlMediaCollectionModel::destroySelectedMedia() {
  ...
  GalleryManager::GetInstance()->GetMediaCollection()->DestroyMany(
...
void QmlMediaCollectionModel::destroyMedia(QVariant vmedia) {
  ...
  if (media != NULL)
    GalleryManager::GetInstance()->GetMediaCollection()->Destroy(media, true, true);
}
...
void QmlMediaCollectionModel::set_monitored(bool monitor) {
  ...
  if (monitor)
    MonitorSourceCollection(GalleryManager::GetInstance()->GetMediaCollection());
  else
    StopMonitoring();
